...
using AuthServerConsumer2.API.Models;
...
namespace AuthServerConsumer2.API.Controllers;

[Authorize]
[Route("api/[controller]")]
[ApiController]
public class CategoryController(IHttpClientFactory _httpClientFactory) : ControllerBase
{
    [HttpGet]
    public async Task<IActionResult> GetCategories()
    {
        ...
        using var httpRequest = new HttpRequestMessage(HttpMethod.Get, "api/Category/GetList");
        ...
        var categories = await httpResponse.Content.ReadAsStringAsync();
        return Content(categories, "application/json");
    }
}
